...
struct TestingSessionView: View {
    ...
    private func playerMetricsRows(_ session: SessionData) -> [(String, String)] {
        let rows: [(String, String)] = [
            ...
            ("avgNetworkBitrate", formatMbpsValue(metricDouble(session, "player_metrics_avg_network_bitrate_mbps"))),
            ("networkBitrate", formatMbpsValue(metricDouble(session, "player_metrics_network_bitrate_mbps"))),
...
struct BitrateChartPanel: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 8) {
            ...
            .chartForegroundStyleScale([
                ...
                "Player avg_network_bitrate": colorPlayer,
    ...
    private var bitrateSeries: [ChartSeries] {
        [
            ...
            ChartSeries(label: "Player avg_network_bitrate", samples: state.playerEstimate, color: colorPlayer, lineWidth: 1.5, dash: [6, 4], interpolation: .linear),
